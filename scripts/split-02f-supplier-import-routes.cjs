...
const inputPath = path.join(partsDir, "02f-supplier-import-routes.js");
const lines = fs.readFileSync(inputPath, "utf8").split(/\r?\n/);

const chunks = [
  { name: "02f-supplier-picking-invoices-route.js", start: 1, end: 28 },
  { name: "02f-ozon-yandex-import-send-route.js", start: 30, end: 209 },
  { name: "02f-ozon-yandex-import-maint-routes.js", start: 211, end: 259 },
  { name: "02f-yandex-cleanup-preview-history-routes.js", start: 261, end: 300 },
  { name: "02f-yandex-cleanup-action-routes.js", start: 302, end: lines.length },
];
...
if (!source.includes('"02f-supplier-import-routes.js"')) {
  throw new Error("02f-supplier-import-routes.js not found in source.js");
}
source = source.replace(
  '  "02f-supplier-import-routes.js",\n',
  `${chunks.map((c) => `  "${c.name}",`).join("\n")}\n`,
);
fs.writeFileSync(sourcePath, source);

console.log("split-02f-supplier-import-routes complete", { chunks: chunks.length, totalLines: lines.length });
