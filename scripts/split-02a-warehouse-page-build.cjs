...
const inputPath = path.join(partsDir, "02a-warehouse-page-build.js");
const lines = fs.readFileSync(inputPath, "utf8").split(/\r?\n/);

const chunks = [
  { name: "02a-warehouse-group-count.js", start: 1, end: 72 },
  { name: "02a-warehouse-fast-group-page.js", start: 73, end: 161 },
  { name: "02a-warehouse-page-groups.js", start: 162, end: 353 },
  { name: "02a-warehouse-page-siblings.js", start: 355, end: lines.length },
];
...
if (!source.includes('"02a-warehouse-page-build.js"')) {
  throw new Error("02a-warehouse-page-build.js not found in source.js");
}
source = source.replace(
  '  "02a-warehouse-page-build.js",\n',
  `${chunks.map((c) => `  "${c.name}",`).join("\n")}\n`,
);
fs.writeFileSync(sourcePath, source);

console.log("split-02a-warehouse-page-build complete", { chunks: chunks.length, totalLines: lines.length });
