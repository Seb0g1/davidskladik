...
const inputPath = path.join(partsDir, "02a-ozon-api.js");
const lines = fs.readFileSync(inputPath, "utf8").split(/\r?\n/);

const chunks = [
  { name: "02a-ozon-api-errors-batch.js", start: 1, end: 97 },
  { name: "02a-ozon-api-request.js", start: 98, end: 177 },
  { name: "02a-ozon-price-send-verify.js", start: 178, end: 288 },
  { name: "02a-ozon-warehouse-stock.js", start: 290, end: lines.length },
];
...
if (!source.includes('"02a-ozon-api.js"')) {
  throw new Error("02a-ozon-api.js not found in source.js");
}
...
console.log("split-02a-ozon-api complete", { chunks: chunks.length, totalLines: lines.length });
