...
async function main() {
  ...
  try {
    ...
    for (const rel of ["server.js", "scripts/migrate-warehouse-canonical-ids.cjs", "scripts/audit-canonical-id-mismatches.cjs", "scripts/audit-warehouse-catalog-health.cjs"]) {
