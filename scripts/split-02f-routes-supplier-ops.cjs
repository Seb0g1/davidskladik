...
const inputPath = path.join(partsDir, "02f-routes-supplier-ops.js");
const lines = fs.readFileSync(inputPath, "utf8").split(/\r?\n/);

const chunks = [
  { name: "02f-supplier-cart-routes.js", start: 1, end: 356 },
  { name: "02f-supplier-import-routes.js", start: 357, end: 748 },
  { name: "02f-supplier-export-routes.js", start: 749, end: lines.length },
];
...
if (!source.includes('"02f-routes-supplier-ops.js"')) {
  throw new Error("02f-routes-supplier-ops.js not found in source.js");
}
...
console.log("split-02f-routes-supplier-ops complete", { chunks: chunks.length, totalLines: lines.length });
