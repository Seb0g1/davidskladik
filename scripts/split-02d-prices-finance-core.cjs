...
const inputPath = path.join(partsDir, "02d-prices-finance-core.js");
const lines = fs.readFileSync(inputPath, "utf8").split(/\r?\n/);

const chunks = [
  { name: "02d-finance-normalize-helpers.js", start: 1, end: 211 },
  { name: "02d-finance-supplier-ledger.js", start: 212, end: 417 },
  { name: "02d-finance-orders-storage.js", start: 419, end: 539 },
  { name: "02d-finance-list-query.js", start: 541, end: lines.length },
];
...
if (!source.includes('"02d-prices-finance-core.js"')) {
  throw new Error("02d-prices-finance-core.js not found in source.js");
}
source = source.replace(
  '  "02d-prices-finance-core.js",\n',
  `${chunks.map((c) => `  "${c.name}",`).join("\n")}\n`,
);
fs.writeFileSync(sourcePath, source);

console.log("split-02d-prices-finance-core complete", { chunks: chunks.length, totalLines: lines.length });
