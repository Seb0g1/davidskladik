...
const apiOnlyEnv = {
  ...
  BULLMQ_ENABLED: "true",
  AUTO_SYNC_INITIAL_DELAY_SECONDS: "86400",
  AUTO_SYNC_MINUTES: "0",
...
const workerOnlyEnv = {
  ...
  // 150→40, 600→160, 5min→10min: reconciler писал 600 upsert'ов за тик,
  // каждый с ~15мс napi-overhead = 9с блокировки event loop → PM timeouts.
  LINKED_RECONCILER_BATCH_SIZE: "40",
  LINKED_RECONCILER_MAX_PRODUCTS_PER_TICK: "160",
  LINKED_RECONCILER_INTERVAL_MINUTES: "10",
