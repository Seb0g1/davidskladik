...
app.post("/api/operations", requireAdmin, async (request, response, next) => {
  try {
    ...
    if (!["yandex-import-send", "yandex-stock-sync", "linked-supplier-recovery", "ozon-linked-unarchive", "restore-archived-stock", "yandex-card-quality-ai-drafts", "repair-pricemaster-group-links", "health-deep"].includes(type)) {
