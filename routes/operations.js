...
app.post("/api/operations", requireAdmin, async (request, response, next) => {
  try {
    ...
    if (!["yandex-import-send", "yandex-stock-sync", "yandex-price-push", "linked-supplier-recovery", "ozon-linked-unarchive", "restore-archived-stock", "yandex-card-quality-ai-drafts", "repair-pricemaster-group-links", "marketplace-supplier-cart-preview", "marketplace-supplier-cart-commit", "health-deep"].includes(type)) {
