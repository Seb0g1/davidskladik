function normalizeSupplierPickingRow(input = {}) {
  ...
  return {
    ...
    supplierReturnedBy: cleanText(input.supplierReturnedBy),
    supplierReturnedAt: input.supplierReturnedAt || null,
    supplierReturnAmountRub: input.supplierReturnAmountRub != null ? (normalizeFinanceMoney(input.supplierReturnAmountRub, 0) || null) : null,
