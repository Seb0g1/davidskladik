...
function operationTitle(type = "") {
  const titles = {
    ...
    "initialize-linked-ozon-stock": "Инициализировать FBS-остатки Ozon (привязки, «не обновлён»)",
    "scan-and-fix-zero-stock": "Сканировать и исправить нулевые остатки (все маркетплейсы)",
    "yandex-card-quality-ai-drafts": "Yandex card quality AI drafts",
    "repair-dalik-disambiguation-links": "Ремонт привязок Далик (disambiguation)",
