...
const YANDEX_WRONG_CATEGORY_PATTERNS = [
  // Одежда и обувь
  /сумк/i, /костюм/i, /юбк/i, /худи/i, /(^|\s)вина(\s|$)/i, /одежд/i, /обув/i, /плать/i,
  /футболк/i, /брюк/i, /куртк/i, /носк/i, /спортивн/i, /олимпийк/i, /анорак/i,
  /для взрослых/i, /товары для взрослых/i, /эротик/i, /18\+/i, /полуграци/i,
  // Детское
  /детск/i, /коляск/i, /игрушк/i,
  // Авто и техника
  /автомобил/i, /автоэмал/i, /шин[ыа]/i, /моторн.*масл/i, /антифриз/i,
  /присадк/i, /диски колёсн/i, /полирол.*шин/i,
  /сплит/i, /кулер/i, /кондиционер/i, /холодильн/i, /частотн.*преобразовател/i,
  /рэков/i, /компьютерн.*кресл/i, /шлагбаум/i, /комплект.*умного дома/i,
  /сетевые хранилищ/i,
  // Еда и напитки
  /напит/i, /шампанск/i, /газирован/i, /кофе/, /десерт/i, /сироп.*десертн/i,
  /масло растительн/i, /уксус.*волос/i,
  // Спорт и туризм
  /лыж/i, /плаван/i, /ружь.*охот/i, /подводн.*охот/i, /мультистанци/i,
  /рюкзак/i, /лодк[аи]/i, /горн.*лыж/i,
  // Строительство и промышленность
  /краска строительн/i, /шлагбаум/i, /вытяжк/i, /духовой шкаф|духовые шкаф/i,
  /промышленн/i, /расходн.*лаборатор/i,
  // Медицина
  /антибиотик/i,
  // Прочее явно нерелевантное
  /аквариум/i, /диффузор/i, /канцеляр/i, /посуд/i, /водород/i, /интимн/i, /съедобн/i,
  /ароматизатор/i, /жиросжигател/i, /стирк/i, /дистиллирован/i,
];
