module.exports = {
  ...
  buildWbCardPayload,
  wbSupplierPurchaseRub,
  wbSupplierPriceRub,
  wbDimensionsFromProduct,
  getWbAccounts,
  getWbAccountByTarget,
  // WB ops-скрипты: цепочка импорта запускается на сервере отдельным процессом
  // с большим heap — скан каталога не влезает в память процесса api.
  readWbImportRules,
  writeWbImportRules,
  collectWbImportCandidates,
  summarizeWbImportPreview,
  loadWbLinkedOzonProducts,
  wbExtractImageUrls,
  wbPing,
  wbCardsList,
  wbCardsTrashList,
  ...
  wbTnvedList,
  resolveWbTnvedCharacteristic,
  backfillWbTnvedCharacteristics,
  enrichWbCards,
  wbGenerateBarcodes,
  wbMediaSave,
  wbSetPrices,
  ...
  loadAvitoSupplierPricingMap,
  chunkArray,
  getPrisma,
  normalizeAvitoImportRules,
  normalizeAvitoListing,
  applyAvitoLiveState,
  dedupeAvitoListingsBySource,
  runAvitoFeedRefresh,
  runAvitoAutoSync,
  triggerAvitoAutoloadUpload,
  extractOzonInfoImageUrls,
  applyWarehouseNextPriceLimits,
  warehousePriceClampReason,
  readAiImageJobs,
  writeAiImageJobs,
  normalizeAiImageJob,
  publicAiImageJob,
