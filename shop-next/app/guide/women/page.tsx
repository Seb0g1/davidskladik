...
export const metadata: Metadata = {
  title: `Лучшие женские ароматы — гид | ${SITE_NAME}`,
  description: "Гид по женской парфюмерии: как выбрать аромат, EDT vs EDP, сезонность и топ нот 2026.",
  alternates: { canonical: "/guide/women" },
  openGraph: { title: `Лучшие женские ароматы — гид — ${SITE_NAME}`, url: `${SITE_URL}/guide/women` },
};
...
export default function WomenGuidePage() {
  ...
  const breadcrumb = breadcrumbJsonLd([{ name: "Главная", url: "/" }, { name: config.headline, url: "/guide/women" }]);
  const articleLd = { "@context": "https://schema.org", "@type": "Article", headline: config.headline, description: "Гид по женской парфюмерии: как выбрать аромат, EDT vs EDP, сезонность и топ нот 2026.", url: `${SITE_URL}/guide/women`, publisher: { "@type": "Organization", name: SITE_NAME, logo: `${SITE_URL}/favicon.svg` } };
  return (
    <>
